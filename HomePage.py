...
class RecipeManagerApp:
    def __init__(self, window, master):
        ...
        # Window icon
        icon = PhotoImage(file='RecipeManagerApp\\images\\pic-icon.png')
    ...
    def show_signin(self):
        ...
        # Background image
        global img1
        img1 = ImageTk.PhotoImage(Image.open("RecipeManagerApp\\images\\recipe2.jpg"))
    ...
    def show_dashboard(self, username):
        ...
        # Add Recipe
        dashboard_image = Image.open('RecipeManagerApp\\images\\add-icon.png')
        ...
        manage_image = Image.open('RecipeManagerApp\\images\\cook.png')
        ...
        # Shared Recipes
        shared = Image.open('RecipeManagerApp\\images\\share.png')
        ...
        # Logo
        logo_image = Image.open('RecipeManagerApp\\images\\hyy.png')
    ...
    def show_signup(self):
        ...
        # Background image
        global img2
        img2 = ImageTk.PhotoImage(Image.open("RecipeManagerApp\\images\\recipe2.jpg"))
